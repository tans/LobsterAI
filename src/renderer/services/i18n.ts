...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 GeekClaw Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'GeekClaw 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 GeekClaw 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 GeekClaw 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'GeekClaw 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 GeekClaw 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'GeekClaw 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'GeekClaw 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道GeekClaw服务协议',
    privacyDialogDesc: '在使用网易有道GeekClaw之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道GeekClaw服务协议',
    privacyDialogAccept: '我已阅读并同意',
    privacyDialogReject: '拒绝',
    welcomeTitle: '欢迎使用GeekClaw',
  ...
  en: {
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit GeekClaw Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // GeekClaw
    cowork: 'GeekClaw',
    coworkSettings: 'GeekClaw Settings',
    ...
    coworkWorkingDirectoryHint: 'GeekClaw will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for GeekClaw...',
    coworkSystemPromptHint: "Optional system prompt to customize GeekClaw's behavior",
    ...
    coworkModelSettingsHint:
      'GeekClaw uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save GeekClaw settings. Please try again.',
    ...
    coworkPermissionDescription: 'GeekClaw is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'GeekClaw needs your input',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao GeekClaw Terms of Service',
    privacyDialogDesc:
      'Before using NetEase Youdao GeekClaw, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao GeekClaw Terms of Service',
    privacyDialogAccept: 'I have read and agree',
    privacyDialogReject: 'Decline',
    welcomeTitle: 'Welcome to GeekClaw',
